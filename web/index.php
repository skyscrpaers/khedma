			...
			<?php
                    if (ISSET($_SESSION['type']) && ISSET($_SESSION['username'])) {
                        if ($_SESSION['type'] == 1) {
                            ?>
			<div class="w3l_login">
				<li><a href="../nalika-master/nalika/index.html" >Admin Dashboard</a></li>
			<li><a href="../core/logout.php" >Se Déconnecter</a></li>
				<?php
                        } else { ?>
                <li><a href="../front/modifierUser.php?id=<?PHP echo   $_SESSION['id']; ?>" >Profile</a></li>
				<li><a href="../core/logout.php" >Se Déconnecter</a></li>
				<?php
                        }
                    }else{
				...
				<li><a href="../core/logout.php" >Register</a></li>
				<?php
                        }
                        ?>
			</div>
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						<li><a href="index.html" class="act">Home</a></li>	
												<li><a href="Categories.php" class="act">Categories</a></li>	
						<!-- Mega Menu -->
